...
export class PostCommentsQueryDto {
  @ApiProperty({ required: true, default: 10, minimum: 1, description: 'Number of comments to return' })
  @IsInt()
  limit: number = 10;
...
export class CreateCommentDto {
  ...
  @ApiProperty({ required: false, description: 'Optional media object returned by upload endpoint' })
  @IsOptional()
  @IsObject()
  media?: any;
}